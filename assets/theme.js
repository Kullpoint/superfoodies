(function (factory) {
  ...
  var Cart = /*#__PURE__*/function () {
    ...
    _createClass(Cart, [{
      ...
      value: function _updateQuantity(event, target) {
        ...
        var parsedQuantity = 1; // If we are in "page" mode, we reload the page instead of doing that in Ajax to have a better compatibility with apps
  ...
  var MobileNavigation = /*#__PURE__*/function () {
    ...
    _createClass(MobileNavigation, [{
      ...
      value: function _openPanel(event, target) {
        ...
        document.querySelector('.mobile-menu__inner').classList.add('toggled')
      }
    }, {
      key: "_closePanel",
      value: function _closePanel(event, target) {
        ...
        document.querySelector('.mobile-menu__inner').classList.remove('toggled')
      }
    }, {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _onVariantChanged(previousVariant, newVariant) {
        ...
        document.dispatchEvent(new CustomEvent('firmhouse:load:products', {
          bubbles: true,
          detail: {
            variant: newVariant
          }
      ...
      value: function _onOptionChanged(event, target) {
        ...
        if(this.currentVariant.inventory_quantity == 0){
          document.querySelector('.product-form__add-button.main_atc_btn').style.display = 'none';
          document.querySelector('.product-form__add-button.sold_out_btn').style.display = 'block';
        }
        else{
          document.querySelector('.product-form__add-button.main_atc_btn').style.display = 'flex';
          document.querySelector('.product-form__add-button.sold_out_btn').style.display = 'none';
        }
  ...
  */
  ...
  var ValuePicker = /*#__PURE__*/function () {
    ...
    _createClass(ValuePicker, [{
      ...
      value: function _selectValue(event, target) {
        ...
        console.log('123', target.getAttribute('data-value'))
        this._close();
      }
    }, {
      key: "_onFocusOut",
      ...
      value: function _reload(pushState) {
        ...
        return fetch(sectionUrl, {
          ...
          response.text().then(function (content) {
            ...
            if($('.collection__active-filters div').length) {
              document.querySelector('.collection__filters-header').classList.add('active');
              console.log(1)
            } else {
              document.querySelector('.collection__filters-header').classList.remove('active');
              console.log(2)
            }
    ...
    _createClass(SearchBar, [{
        ...
        if (currentInput === '') {
          ...
          var queryOptions = {
            ...
            credentials: 'same-origin'
              ...
              queries = [fetch("".concat(window.routes.searchUrl, "?view=ajax&q=").concat(productQuery, "&type=product"), queryOptions)];
      ...
      value: function _onFormSubmit(event) {
        if (this.inputElement.value === '') {
          ...
          cloneNode.value = "".concat(this.productTypeFilter !== '' ? "product_type:".concat(this.productTypeFilter, " AND ") : '').concat(this.inputElement.value, "*"); // We remove the "q" attribute on existing node so it's not submitted
  ...
  (function () {
    ...
    sections.register('product-item', ProductItem);
